...
```{r chapter_two, child = './Sections/10_Chapter_two_SNA.Rmd', eval = F}
```
...
```{r chapter_three, child = './Sections/11_Chapter_three_media.Rmd', eval = F}
```
...
```{r chapter_four, child = './Sections/12_Chapter_four_ERGM.Rmd', eval = F}
```
...
```{r appendix_a, child = './Sections/13_Appendix_A_methods.Rmd', eval = F}
```
...
```{r appendix_b, child = './Sections/14_Appendix_B_Survey.Rmd', eval = F}
```
...
```{r appendix_c, child = './Sections/15_Appendix_C_Interview.Rmd', eval = F}
```
...
```{r appendix_c, child = './Sections/16_Appendix_D_Ethics.Rmd', eval = F}
```
